...
export class StatusAreaBridge {
    ...
    /**
     * @param {object} map role -> zone
     * @param {string[]} legacyHidden
     * @param {{allHidden?: boolean}} [opts]
     */
     ...
     * Priority:
     * 1. Master hide-all
     * 2. Explicit claim from preset (extension:role)
     * 3. foreignRoleZones entry
     * 4. Default → right (show on left edge of right zone)
     */
    _placementFor(role) {
        if (this._allHidden)
            return 'hidden';
