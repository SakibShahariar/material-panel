...
export class StatusAreaBridge {
    ...
    /**
     * Opt-in only. null = not on Material Panel.
     * foreignRoleZones is the single source of truth (including explicit "hidden").
     * Preset claims are ignored so Off cannot be overridden back to Right.
     */
    _wantedPlacement(role) {
        ...
        // Model B default: never auto-place (claims disabled for tray)
        return null;
    }
