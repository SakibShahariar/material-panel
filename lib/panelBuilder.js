...
const END4_RIGHT = ['notifications', 'networkSpeed', 'volume', 'battery', 'quicksettings'];
...
export class PanelBuilder {
    ...
    _renderEnd4(preset, scale, hiddenModules) {
        ...
        const mkGroup = () => {
            ...
            try {
                g.style = 'background-color: rgba(255,255,255,0.06); border-radius: 999px; padding: 2px 8px; spacing: 6px;';
            } catch (e) {}
            return g;
        };
