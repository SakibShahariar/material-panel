...
export class PanelBuilder {
    ...
    _renderDefault(preset, scale, hiddenModules) {
        // BinLayout + shrink-wrap zones (expand:false): left/center/right
        // pack to their content. expand:true made each zone claim full width
        // and left a huge empty gap beside the right pill on wide monitors.
