...
export const SLIDER_STYLES = [
    ...
    {id: 'wavy', label: 'Wavy liquid fill', tier: 'Cairo',
        ...
        rowSafe: true},
    {id: 'rails', label: 'Vertical twin rails (tall)', tier: 'Experimental',
        desc: 'Vertical rail — uses a tall QS row; not for End-4 dual capsule.',
        rowSafe: false},
    {id: 'arc', label: 'Arc ring dial (tall)', tier: 'Experimental',
        desc: 'Rotary dial — uses a tall QS row; not for End-4 dual capsule.',
        rowSafe: false},
];
