...
const DEFAULT_CONFIG = {
    ...
    trayDrawer: true,
    // Built-in SNI watcher (set false if apps crash on tray register)
    statusNotifier: true,  // vendored full AppIndicator stack
...
export class ConfigStore {
    ...
    load() {
        ...
        try {
            ...
            if (merged.statusNotifier == null) merged.statusNotifier = true;
