...
const DEFAULT_CONFIG = {
    ...
    //   clipping/mismatch.
    // - gap: independent px margin between pills and the screen edge -
    //   genuinely orthogonal to the icon/pill/text proportions, safe to
    //   control separately.
    panelSize: {
        scale: 1.0,
        gap: 5,
    ...
    load() {
        ...
        try {
            ...
            merged.panelSize = {
                ...
                gap: parsed.panelSize?.gap ?? DEFAULT_CONFIG.panelSize.gap,
            };
