...
const DEFAULT_CONFIG = {
    ...
    // 'end4' = floating shrink-wrap BarGroups | 'default' = wider zone strips
    layoutStyle: 'end4',
    panelSize: {
        scale: 1.0,
        gapTop: 8,
        gapBottom: 6,
        gapSide: 14, // horizontal float inset (end-4)
    },
    // '24h' or '12h' (AM/PM)
    clockFormat: '24h',
    hiddenModules: [],
    ...
    presets: {
        default: {
            // end-4-inspired: resources+clock center, nav left, status right
            zones: {
...
export class ConfigStore {
    ...
    save(config) {
        ...
        if (!Number.isFinite(gapSide))
            gapSide = (out.layoutStyle === 'end4') ? 14 : 0;
