...
export class ConfigStore {
    ...
    load() {
        ...
        try {
            ...
            // Migrate hiddenForeignRoles → foreignRoleZones.hidden
            for (const r of merged.hiddenForeignRoles) {
                if (!merged.foreignRoleZones[r])
                    merged.foreignRoleZones[r] = 'hidden';
            }
