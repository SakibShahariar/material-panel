...
export function buildEnd4CalendarSection() {
    ...
    style(outer, 'background-color: rgba(255,255,255,0.07); border-radius: 16px; padding: 12px 10px; spacing: 8px;');
    ...
    for (const d of ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su']) {
        const lab = new St.Label({text: d, x_align: Clutter.ActorAlign.CENTER});
        style(lab, 'font-size: 10px; opacity: 0.55; width: 36px;');
