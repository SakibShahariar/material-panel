...
export function buildEnd4CalendarSection() {
    ...
    style(outer, 'background-color: rgba(255,255,255,0.07); border-radius: 14px; padding: 10px 8px; spacing: 8px; max-width: 300px;');
    ...
    for (const d of ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su']) {
        ...
        style(lab, 'font-size: 10px; opacity: 0.55; min-width: 28px;');
        ...
        for (let i = 0; i < cells.length; i += 7) {
            ...
            for (let c = 0; c < 7; c++) {
                ...
                if (d === null) {
                    ...
                    style(spacer, 'min-width: 28px; min-height: 26px;');
                ...
                if (isToday) {
                    style(cell,
                        'font-size: 11px; font-weight: 700; min-width: 26px; min-height: 26px;'
                        + ' background-color: #f5b8d0; color: #1a1a1a; border-radius: 999px;');
                } else {
                    style(cell, 'font-size: 11px; min-width: 26px; min-height: 26px; opacity: 0.9;');
                }
                row.add_child(cell);
            }
