...
export function createSlider({initialValue = 0, onChange, width = DEFAULT_TRACK_WIDTH}) {
    ...
    try {
        track.style = `width: ${TRACK_WIDTH}px; height: ${TRACK_HEIGHT}px; background-color: rgba(255,255,255,0.18); border-radius: 999px;`;
    } catch (e) {}
    ...
    try {
        fill.style = 'height: 16px; background-color: #f5b8d0; border-radius: 999px;';
    } catch (e) {}
    ...
    try {
        knob.style = 'width: 16px; height: 16px; background-color: #ffffff; border-radius: 999px;';
    } catch (e) {}
