...
export class ThemeManager {
    ...
    _render(vars) {
        ...
        const qsPopupBg = rgba('surface', 0.82, 'rgba(24, 24, 37, 0.82)');
...
/* Single surface only on content — BoxPointer must stay transparent or Blur/Shell shows a second outer frame */
...
/* All material-panel popups: kill BoxPointer outer plate (Blur my Shell / double frame) */
