...
.material-panel-memory-label,
.material-panel-disk-label,
.material-panel-gpu-label,
.material-panel-bt-footer-label,
.material-panel-qs-bt-header-label,
...
`;
    ...
    apply(sourcePath, panelSize = {}, layoutStyle = 'default') {
        ...
        try {
            ...
            globalThis._materialPanelOnSurface = textColor;
