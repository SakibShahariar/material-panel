...
.material-panel-layout-end4 .material-panel-workspace-btn.app {
    ...
    color: inherit;
    font-size: inherit;
    background-color: alpha(${textColor}, 0.18);
}
/* Active workspace with focused app: primary ring, icon stays full-color */
...
.material-panel-layout-end4 .material-panel-workspace-btn.app .material-panel-workspace-app {
    /* full-color app icons — do not force symbolic/primary tint */
    color: inherit;
}
