...
.material-panel-layout-end4 .material-panel-workspace-dot {
    width: ${px(Math.max(8, Math.round(pillHeight * 0.28)))};
    height: ${px(Math.max(8, Math.round(pillHeight * 0.28)))};
    min-width: ${px(Math.max(8, Math.round(pillHeight * 0.28)))};
    min-height: ${px(Math.max(8, Math.round(pillHeight * 0.28)))};
    padding: 0;
    margin: 0 2px;
    font-size: 0;
    border-radius: 999px;
...
.material-panel-layout-end4 .material-panel-workspace-dot.active {
    width: ${px(Math.max(18, Math.round(pillHeight * 0.55)))};
    min-width: ${px(Math.max(18, Math.round(pillHeight * 0.55)))};
    border-radius: 999px;
}
