...
/* App icons from SVG themes are often painted in primary.
 * Active chip uses on_primary so primary glyphs keep contrast (M3 pair).
 * Empty active dots still use solid primary (no icon). */
...
/* end-4 BarGroups — one soft pill per group; chips inside are bare */
...
/* Empty dots only — never crush .app icons to 8px */
.material-panel-layout-end4 .material-panel-workspace-btn.active:not(.app),
.material-panel-layout-end4 .material-panel-workspace-dot.active {
    width: 20px;
    min-width: 20px;
    height: 8px;
