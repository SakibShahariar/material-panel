...
.material-panel-layout-default .material-panel-zone-right {
    margin-right: 0 !important;
    padding-right: 2px !important;
}
.material-panel-layout-default .material-panel-zone-right-row {
    spacing: 6px;
    padding-right: 0;
}
.material-panel-layout-default .material-panel-bar-content-default {
    padding-right: 0;
}
.material-panel-layout-default .material-panel-zone-left {
    margin-left: 2px;
}
.material-panel-layout-default .material-panel-tray-icon-strip {
    padding: 0 2px;
    spacing: 4px;
}
