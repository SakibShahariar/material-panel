...
/* end-4 continuous bar (Hug): rectangular content, corners drawn under */
...
.material-panel-layout-end4 .material-panel-zone-center {
    margin: ${px(Math.max(2, gapTop - 2))} 0 ${px(Math.max(2, gapBottom - 2))} 0;
    padding: ${px(padV)} ${px(padH)};
    border-radius: ${px(Math.round(pillHeight * 0.9))};
    box-shadow: none;
    border: none;
}
.material-panel-layout-end4 .material-panel-zone-center {
