...
/* Solid symbolic tint — never leave StIcon at default white inside our chrome */
.material-panel-e4qs-menu StIcon,
.material-panel-qs-popup StIcon,
.material-panel-popup StIcon,
.material-panel-e4qs-header-btn StIcon,
.material-panel-qs-power-btn StIcon {
    -st-icon-style: symbolic;
    color: ${accentBg};
}
.material-panel-e4qs-menu .pressed StIcon,
.material-panel-e4qs-menu :active StIcon,
.material-panel-qs-popup .pressed StIcon,
.material-panel-qs-popup :active StIcon,
.material-panel-popup .pressed StIcon,
.material-panel-popup :active StIcon,
.material-panel-e4qs-header-btn.pressed StIcon,
.material-panel-e4qs-header-btn:active StIcon,
.material-panel-qs-power-btn.pressed StIcon,
.material-panel-qs-power-btn:active StIcon,
.material-panel-qs-tile.active StIcon,
.material-panel-qs-bt-tile-row.active StIcon,
.material-panel-qs-wifi-row.active StIcon,
.material-panel-qs-bt-device.connected StIcon {
    -st-icon-style: symbolic;
    color: ${onAccent};
}
