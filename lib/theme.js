...
.material-panel-qs-slider {
    -barlevel-background-color: ${chipBg};
    -barlevel-active-background-color: ${accentBg};
    -slider-handle-color: ${accentBg};
    -slider-handle-border-color: ${accentBg};
}
`;
    }
    ...
    apply(sourcePath) {
        ...
        applyIcons(this._extensionPath, vars['on_surface'] ?? '#cdd6f4', vars['on_primary'] ?? '#1e1e2e');
    }
