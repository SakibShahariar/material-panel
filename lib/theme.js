...
/* Root class is on the grid: material-panel-qs-tiles--{id} */
...
.material-panel-qs-tiles--minimal .material-panel-qs-wifi-row {
    background-color: rgba(58, 60, 78, 0.35);
...
.material-panel-qs-tiles--minimal .material-panel-qs-wifi-row:hover {
    background-color: ${hoverBg};
    border-color: rgba(205, 214, 244, 0.30);
}
...
.material-panel-qs-tiles--tonal .material-panel-qs-wifi-row {
    background-color: rgba(58, 60, 78, 0.45);
}
...
.material-panel-qs-tiles--glass .material-panel-qs-wifi-row {
    ...
    border-radius: 20px;
    background-color: rgba(58, 60, 78, 0.42);
...
.material-panel-qs-tiles--aurora .material-panel-qs-wifi-row {
    ...
    background-color: rgba(58, 60, 78, 0.90);
}
.material-panel-qs-tiles--aurora .material-panel-qs-tile.active {
    border-color: ${accentBg};
    background-color: rgba(203, 166, 247, 0.12);
    box-shadow: 0 0 14px rgba(203, 166, 247, 0.25);
}
...
.material-panel-qs-tiles--squiggle .material-panel-qs-tile.active {
    background-color: ${accentBg};
    color: ${onAccent};
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.28), 0 10px 22px rgba(203, 166, 247, 0.28);
}

/* indicator underline actor */
...
.material-panel-qs-tiles--recessed .material-panel-qs-bt-tile-row {
    background-color: rgba(21, 23, 31, 0.95);
...
/* icon-top geometry hints */
.material-panel-qs-tiles--icon-top .material-panel-qs-tile,
.material-panel-qs-tiles--icon-top .material-panel-qs-bt-tile-row {
    min-height: 80px;
}
...
.material-panel-qs-tiles--icon-only .material-panel-qs-tile-label,
.material-panel-qs-tiles--icon-only .material-panel-qs-wifi-speed,
.material-panel-qs-tiles--icon-only .material-panel-qs-wifi-ssid {
    /* labels hidden via actor visible=false in JS when possible */
}

/* spotlight approximation */
