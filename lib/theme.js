...
`;
    ...
    _renderDimensions({scale = 1.0, gapTop = 5, gapBottom = 4, gapSide = 0, gap, layoutStyle = 'default'} = {}) {
        ...
        const sideMargin = end4 ? Math.max(8, Math.round(10 * scale)) : 3;
        const zoneSpacing = end4 ? Math.max(3, Math.round(4 * scale)) : 8;
